...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { publish_date: @blog_post.publish_date, published: @blog_post.published, title: @blog_post.title, url: @blog_post.url }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { publish_date: @blog_post.publish_date, published: @blog_post.published, title: @blog_post.title, url: @blog_post.url }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
